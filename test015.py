...
# HTML <table>......</table>
#
tableTh = '''<table border="1" width="900" cellspacing="0" cellpadding="5" bordercolor="#333333">
              <tr>
            ...
            '''
tableTd = '''<tr>
                <td bgcolor="#F2F2F2" align="center" nowrap>{0}</td>
                <td bgcolor="#F2F2F2" valign="top" width="150">{1}</td>
                <td bgcolor="#F2F2F2" valign="top" width="200">{2}</td>
                <td bgcolor="#F2F2F2" valign="top" width="200">{3}</td>
                <td bgcolor="#F2F2F2" valign="top" width="200">{4}</td>
                <td bgcolor="#F2F2F2" valign="top" width="200">{5}</td>
            </tr>
            '''
tableTc = "</table>"
...
def makeTable():
    ...
    # <td>タグ
    for row in rowList:
        htmlBuff = htmlBuff + tableTd.format(seqNo, row[0], row[1], row[2], row[3], row[4])
        seqNo += 1
    # </table>タグ
